...
######################################################################################
#Images
ImgBalloon = pygame.image.load('C:/Users/DELL/Desktop/PPSU/Projects/Balloon-Pop-Game-Using-Python-OpenCV-main/Ballon Pop (Pygame)/Images_Project/BalloonRed.png').convert_alpha()

ImgBalloon_2 = pygame.image.load('C:/Users/DELL/Desktop/PPSU/Projects/Balloon-Pop-Game-Using-Python-OpenCV-main/Ballon Pop (Pygame)/Images_Project/BalloonBlue.png').convert_alpha()
ImgBalloon_2 = pygame.transform.scale(ImgBalloon_2,(115,200))

ImgBalloon_3 = pygame.image.load('C:/Users/DELL/Desktop/PPSU/Projects/Balloon-Pop-Game-Using-Python-OpenCV-main/Ballon Pop (Pygame)/Images_Project/BalloonMultiColor.png').convert_alpha()
ImgBalloon_3 = pygame.transform.scale(ImgBalloon_3,(200,250))

ImgPop = pygame.image.load('C:/Users/DELL/Desktop/PPSU/Projects/Balloon-Pop-Game-Using-Python-OpenCV-main/Ballon Pop (Pygame)/Images_Project/Pop.png').convert_alpha()
...
def ResetBalloon_2():
    BalloonRect_2.x = random.randint(200,image.shape[1]-200)
...
while Start:
    ...
    if (Time < 0):          #If Time Over then
        ...
        font = pygame.font.Font('C:/Users/DELL/Desktop/PPSU/Projects/Balloon-Pop-Game-Using-Python-OpenCV-main/Ballon Pop (Pygame)/Images_Project/Marcellus-Regular.ttf',50)
